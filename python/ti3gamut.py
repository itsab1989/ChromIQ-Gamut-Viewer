...
</style></head><body><div class="row">{''.join(blocks)}</div>{resize}{link}{_spin_script(ids, ({"flat": True, **(spin or {})} if flat else spin), mode, controls, offer)}</body></html>"""
